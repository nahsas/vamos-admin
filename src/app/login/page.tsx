      ...
      <Card className="w-full max-w-sm shadow-xl bg-card/80 backdrop-blur-sm border-white/20 rounded-2xl">
        <CardHeader className="text-center space-y-2">
            <div className="flex justify-center items-center mb-2">
                <Image src="https://vamos-api-v2.sejadikopi.com/api/images?path=Logo/vamos_circle.png" alt="Vamos Logo" width={80} height={80} className="rounded-lg shadow-lg" unoptimized />
            </div>
