        ...
        <CardHeader className="flex items-center justify-center p-4">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-auto">
            <TabsList className="grid grid-cols-2 rounded-full bg-gray-200 p-1 h-auto">
              <TabsTrigger value="dine-in" className="rounded-full data-[state=active]:bg-gradient-to-r from-blue-500 to-purple-600 data-[state=active]:text-white flex items-center gap-2 px-3 py-1.5 text-sm">
                Dine-in
                <Badge className="bg-white text-blue-600 data-[state=inactive]:bg-primary-foreground/90 data-[state=inactive]:text-primary rounded-full h-6 w-6 flex items-center justify-center">{filteredDineInOrders.length}</Badge>
              </TabsTrigger>
              <TabsTrigger value="take-away" className="rounded-full data-[state=active]:bg-gradient-to-r from-blue-500 to-purple-600 data-[state=active]:text-white flex items-center gap-2 px-3 py-1.5 text-sm">
                Take Away
                <Badge className="bg-white text-blue-600 data-[state=inactive]:bg-primary-foreground/90 data-[state=inactive]:text-primary rounded-full h-6 w-6 flex items-center justify-center">{filteredTakeawayOrders.length}</Badge>
              </TabsTrigger>
            </TabsList>
          </Tabs>
        </CardHeader>
