      ...
      <Sidebar>
        <SidebarHeader className="p-4 border-b border-sidebar-border">
          <div className="flex items-center gap-3">
             <Image src="https://vamos-api.sejadikopi.com/storage/Logo/vamos.png" alt="Sejadi Kopi Logo" width={56} height={56} className="rounded-lg border border-sidebar-border shadow-lg" unoptimized />
            <div>
